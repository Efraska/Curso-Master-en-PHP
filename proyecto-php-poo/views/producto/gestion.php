...
<?php elseif(isset($_SESSION['producto']) && $_SESSION['producto'] == 'complete') : ?>
    <strong class="alert_red">Fallo al crear producto, favor de llenar correctamente!!!</strong>
<?php endif; ?>
...
<?php elseif(isset($_SESSION['delete']) && $_SESSION['delete'] == 'complete') : ?>
    <strong class="alert_red">Fallo al borrar el producto, favor de revisar!!!</strong>
<?php endif; ?>
